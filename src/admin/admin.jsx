        ...
        {this.state.isadmin ?
          <>
            ...
            <div className="row">
              ...
              <div className="col-sm-6"><Link to="/admin/reports" className="text-decoration-none"><button className="btn btn-block btn-primary mb-3">Manage Reports</button></Link></div>
